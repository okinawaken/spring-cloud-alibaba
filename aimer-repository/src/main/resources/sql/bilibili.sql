...
(
    ...
    `sex`         tinyint(4) unsigned not null default 0 comment '用户性别：0、未知 1、男 2、女',
    `login_type`  tinyint(4) unsigned not null default 0 comment '登录方式：0、账号密码登录 1、邮件登录 2、cookie登录',
    `platform`    tinyint(4) unsigned not null default 0 comment '第三方平台类型：0、哔哩哔哩',
